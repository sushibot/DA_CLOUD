...
export default function App() {
	...
	/**
		* Loads track from S3 based on track key
		*/
		...
		<div className="h-dvh flex flex-col bg-gray-950 text-white">
			...
			<div className="flex-1 min-h-0 relative overflow-hidden">
				{selectedAlbumId === null ? (
					...
					<TrackList albumId={selectedAlbumId} onBack={() => setSelectedAlbumId(null)} />
				)}
				<div
					className={`absolute inset-0 transition-transform duration-500 ease-in-out ${expanded ? "translate-y-0" : "translate-y-full"
						}`}
				>
					<VisualizerView
